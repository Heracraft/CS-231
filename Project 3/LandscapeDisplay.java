/*
  ...
  Updated by Nehemia Kaaya Mar 11 to scale the window by an optional scale factor
...
public class LandscapeDisplay {
    ...
    public LandscapeDisplay(Landscape scape) {
        ...
        this.canvas = new LandscapePanel(this.scape.getWidth() * this.scale,
                this.scape.getHeight() * this.scale);
    ...
    /**
     * Initializes a display window for a Landscape with a custom scale factor
     * 
     * @param scape the Landscape to display
     */
